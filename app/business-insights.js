...
import { businessModes, dealStages, leadStatusLabels, leadStatuses } from "./business-config.js?v=26";
import { computeMetrics, revenueTargetOf, todayIso } from "./state-model.js?v=26";
