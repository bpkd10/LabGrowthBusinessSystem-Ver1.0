...
import { businessModes, dealStages, leadStatusLabels, leadStatuses } from "./business-config.js?v=29";
import { computeMetrics, revenueTargetOf, todayIso } from "./state-model.js?v=29";
