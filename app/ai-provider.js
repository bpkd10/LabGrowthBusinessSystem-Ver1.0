...
//
// ไฟล์นี้คือสำเนาของเนื้อหาที่เคยอยู่ใน scripts/ai-analysis.mjs (instructions,
// การสร้าง request และการอ่าน response) ย้ายมาไว้ฝั่ง browser เพื่อให้ผู้ใช้เรียก
// ผู้ให้บริการ AI ด้วย API key ของตัวเองโดยตรง โดยไม่ผ่าน server ของเจ้าของระบบ
// ต้นฉบับใน scripts/ai-analysis.mjs ยังอยู่โดยตั้งใจ — จะถูกลบในระยะ 2 ของ ADR
// หลังยืนยันแล้วว่าเส้นทาง BYOK ใช้งานได้จริง (ระหว่างนี้จึงต้องมีสองที่ชั่วคราว)
//
...
// ชื่อ model เริ่มต้น ตรงกับที่ scripts/ai-analysis.mjs เคยใช้กับ key ของเจ้าของระบบ
//
